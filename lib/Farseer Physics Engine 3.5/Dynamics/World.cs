...
namespace FarseerPhysics.Dynamics
{
    ...
    public class World
    {
        ...
        public World(Vector2 gravity)
        {
            ...
            BreakableBodyList = new List<BreakableWall>();
        ...
        public List<BreakableWall> BreakableBodyList { get; private set; }
        ...
        public void AddBreakableBody(BreakableWall breakableBody)
        {
            BreakableBodyList.Add(breakableBody);
        }

        public void RemoveBreakableBody(BreakableWall breakableBody)
        {
