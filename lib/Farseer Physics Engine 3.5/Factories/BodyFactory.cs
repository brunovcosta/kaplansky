...
namespace FarseerPhysics.Factories
{
    public static class BodyFactory
    {
        ...
        public static BreakableWall CreateBreakableBody(World world, Vertices vertices, float density)
        {
            return CreateBreakableBody(world, vertices, density, Vector2.Zero);
        }

        public static BreakableWall CreateBreakableBody(World world, IEnumerable<Shape> shapes)
        {
        ...
        /// <param name="position">The position.</param>
        /// <returns></returns>
        public static BreakableWall CreateBreakableBody(World world, Vertices vertices, float density, Vector2 position)
        {
            List<Vertices> triangles = Triangulate.ConvexPartition(vertices, TriangulationAlgorithm.Earclip);

            BreakableWall breakableBody = new BreakableWall(triangles, world, density);
        ...
        public static BreakableWall CreateBreakableBody(World world, IEnumerable<Shape> shapes, Vector2 position)
        {
            BreakableWall breakableBody = new BreakableWall(shapes, world);
            breakableBody.MainBody.Position = position;
            world.AddBreakableBody(breakableBody);
